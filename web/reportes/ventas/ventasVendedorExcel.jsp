<%-- 
    Document   : ventasVendedorExcel
    Created on : 04/07/2013, 06:54:44 PM
    Author     : Henrri
--%>
        ...
        <div id="documento">
            <div id="contenido">
                ...
                <table style="width: 800px; font-size: 14px; ">
                    <thead>
                        <tr class="bottom2">
                            <th colspan="5">REPORTE GENERAL DE VENTAS <%=objcUtilitarios.fechaDateToString(fechaInicio) + " - " + objcUtilitarios.fechaDateToString(fechaFin)%></th>
                        </tr>
                        <tr>
                            <th colspan="5">VENDEDOR: <%=new cPersona().leer_cod(codVendedor).getNombresC() %></th>
                        </tr>
