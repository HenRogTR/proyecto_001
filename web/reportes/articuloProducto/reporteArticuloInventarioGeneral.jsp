<%-- 
    Document   : reporteArticuloInventarioGeneral
    Created on : 26/03/2013, 06:21:37 PM
    Author     : Henrri
--%>
        ...
        <div id="documento">
            <div id="contenido">
                <table class="tabla-imprimir">
                    <thead>
                        <tr>
                            <th colspan="2">Stock de articulos (<%=ordena%>)</th>
                        </tr>
                        <tr class="top3 bottom2">
                            ...
                            <th><label>Descripción</label></th>
                                <%
                                    if (pCompra != null) {
                                %>
                            <th style="width: 90px;"><label>P. Compra</label></th>
                                <%                                    }
                                    if (pVenta != null) {
                                %>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            %>
                            <td style="text-align: right;padding-right: 8px;"><%=objKardexArticuloProducto != null ? (objKardexArticuloProducto.getStock() == null ? "0" : objKardexArticuloProducto.getStock()) : "0"%></td>
                        </tr>
                        <%
                            }
                        %>
