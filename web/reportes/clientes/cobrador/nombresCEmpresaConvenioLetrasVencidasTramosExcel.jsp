...
<%
    ...
    try {
        ...
        lLetrasDedudas = objcVentaCreditoLetra.letras_codCobrador_codEmpresaConvenio_orderByNombresC(codEmpresaConvenio, codCobrador);
...
<html>
    <head>
        ...
        <title><%=objcUtilitarios.fechaHoraActualNumerosLineal()%> x nombres</title>
        <style>
            td,th{
        ...
        <div id="documento">
            <div id="contenido">
                ...
                <table style="font-size: 14px;width: 2000px;">
                    <thead>
                        <tr class="bottom2">
                            <th colspan="11"><label>Letras X cobrar : Clientes en general</label> :: <%=objEmpresaConvenio.getNombre()%> :: C. <%=objCobrador.getNombres()%></th>
                        </tr>
                        <tr class="bottom1">
