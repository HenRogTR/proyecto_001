<%-- 
    Document   : nombresCLetrasVencidasExcel
    Created on : 10/07/2013, 11:02:29 AM
    Author     : Henrri
--%>
...
<%
    ...
    List lLetrasVencidas = objcVentaCreditoLetra.leer_letrasVencidas_codCobrador_orderByNombresC(fechaVencimiento, codCobrador);
        ...
        <div id="documento">
            <div id="contenido">
                ...
                <table style="width: 700px;font-size: 14px;">
                    <thead>
                        <tr class="bottom2">
                            <th colspan="3"><label>Letras X cobrar : Clientes en general(Apellidos/Nombres) - Vencimiento <%=objcUtilitarios.fechaDateToString(fechaVencimiento)%></label></th>
                        </tr>
                        <tr>
