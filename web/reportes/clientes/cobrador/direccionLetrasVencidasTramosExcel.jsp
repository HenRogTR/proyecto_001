<%-- 
    Document   : direccionLetrasVencidasTramosExcel
    Created on : 16/07/2013, 05:12:45 PM
    Author     : Henrri
--%>
...
<%
    ...
    List lLetrasVencidas = new cVentaCreditoLetra().letras_codCobrador_orderByDireccion(codCobrador);
        ...
        <div id="documento">
            <div id="contenido">
                ...
                <table style="font-size: 14px;width: 2000px;">
                    <thead>
                        <tr class="bottom2">
                            <th colspan="11"><label>Letras X cobrar : Clientes en general</label> :: C. <%=objCobrador.getNombres() %></th>
                        </tr>
                        <tr class="bottom1">
