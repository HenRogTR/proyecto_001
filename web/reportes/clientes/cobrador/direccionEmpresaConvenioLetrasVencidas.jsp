<%-- 
    Document   : direccionEmpresaConvenioLetrasVencidas
    Created on : 17/05/2013, 06:20:49 PM
    Author     : Henrri
--%>
...
<%
    ...
    try {
        ...
        lLetrasVencidas = objcVentaCreditoLetra.letrasVencidas_codCobrador_codEmpresaConvenio_orderByDireccion(fechaVencimiento, codEmpresaConvenio, codCobrador);
        ...
        <div id="documento">
            <div id="contenido">
                ...
                <table style="width: 100%;font-size: 11px;">
                    <thead>
                        <tr class="bottom2">
                            <th colspan="8" style="font-size: 14px;"><label>Letras X cobrar : <%=objEmpresaConvenio.getNombre()%> :: C. <%=objCobrador.getNombres()%></label></th>
                        </tr>
