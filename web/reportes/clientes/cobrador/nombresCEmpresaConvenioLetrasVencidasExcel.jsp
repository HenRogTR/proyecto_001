<%-- 
    Document   : nombresCEmpresaConvenioLetrasExcel
...
<%
    ...
    try {
        ...
        lLetrasVencidas = objcVentaCreditoLetra.leer_codCobrador_deudaPendiente_orderByNombresC_empresaConvenio(fechaVencimiento, codEmpresaConvenio,codCobrador);
