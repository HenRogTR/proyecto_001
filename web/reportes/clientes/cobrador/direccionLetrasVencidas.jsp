<%-- 
    Document   : direccionLetrasVencidas
    Created on : 17/05/2013, 06:25:26 PM
    Author     : Henrri
--%>
...
<%
    ...
    List lLetrasVencidas = objcVentaCreditoLetra.letrasVencidas_codCobrador_orderDireccion(fechaVencimiento, codCobrador);
        ...
        <div id="documento">
            <div id="contenido">
                ...
                <table style="width: 100%;font-size: 11px;">
                    <thead>
                        <tr class="bottom2">
                            <th colspan="8" style="font-size: 14px;"><label>Letras X cobrar : Clientes en general</label>  :: C. <%=objCobrador.getNombres()%></th>
                        </tr>
