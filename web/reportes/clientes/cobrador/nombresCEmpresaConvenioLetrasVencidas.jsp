<%-- 
    Document   : nombresCEmpresaConvenioLetrasVencidas
...
<%
    ...
    try {
        ...
        lLetrasVencidas = objcVentaCreditoLetra.letrasVencidas_codCobrador_codEmpresaConvenio_orderByNombresC(fechaVencimiento, codEmpresaConvenio, codCobrador);
