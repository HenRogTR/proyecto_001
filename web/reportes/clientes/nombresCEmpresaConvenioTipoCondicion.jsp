<%-- 
    Document   : nombresCEmpresaConvenioTipoCondicion
...
<%
    ...
    try {
        ...
        lCliente = objcDatosCliente.leer_empresaConvenio_tipo_condicion_ordenadoNombresC(codEmpresaConvenio, tipo, condicion);
        if (lCliente == null) {
            estado = false;
            ...
            <div id="contenido">
                ...
                <table class="tabla-imprimir">
                    <thead>
                        ...
                        <tr>
                            <th colspan="5"><%=objEmpresaConvenio.getNombre()%> / <%=objcDatosCliente.tipoCliente(tipo)%> / <%=objcDatosCliente.condicionCliente(condicion)%></th>
                        </tr>
