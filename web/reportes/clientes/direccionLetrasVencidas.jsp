...
<%
    ...
    List lLetrasVencidas = new cVentaCreditoLetra().letrasVencidas_orderDireccion(fechaVencimiento);
%>
        ...
        <div id="documento">
            <div id="contenido">
                ...
                <table style="width: 100%;font-size: 11px;">
                    <thead>
                        <tr class="bottom2">
                            <th colspan="8" style="font-size: 14px;"><label>Letras X cobrar : Clientes en general</label></th>
                        </tr>
                        <tr class="bottom1"  style="font-size: 12px;" >
                            <th style="width: 80px;"><label>Númerp</label></th>
