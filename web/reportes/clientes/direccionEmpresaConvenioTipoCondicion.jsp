<%-- 
    Document   : direccionEmpresaConvenioTipoCondicion
...
<%
    ...
    try {
        ...
        lCliente = objcDatosCliente.leer_empresaConvenio_tipo_condicion_ordenadoDireccion(codEmpresaConvenio, tipo,condicion);
        if (lCliente == null) {
            estado = false;
