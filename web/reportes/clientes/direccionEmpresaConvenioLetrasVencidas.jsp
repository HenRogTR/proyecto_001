...
<%
    ...
    try {
        ...
        lLetrasVencidas = objcVentaCreditoLetra.letrasVencidas_codEmpresaConvenio_orderByDireccion(fechaVencimiento, codEmpresaConvenio);
        ...
        <div id="documento">
            <div id="contenido">
                ...
                <table style="width: 100%;font-size: 11px;">
                    <thead>
                        <tr class="bottom2">
                            <th colspan="8" style="font-size: 14px;"><label>Letras X cobrar : <%=objEmpresaConvenio.getNombre()%></label></th>
                        </tr>
