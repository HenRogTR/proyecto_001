...
<%
    ...
    try {
        ...
        lLetrasVencidas = objcVentaCreditoLetra.letrasVencidas_codEmpresaConvenio_tipo_condicion_orderByDireccion(fechaVencimiento, codEmpresaConvenio, tipo, condicion);
