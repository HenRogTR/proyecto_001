...
<%
    ...
    try {
        ...
        lLetrasVencidas = objcVentaCreditoLetra.leer_deudaPendiente_tipo_orderByNombresC_empresaConvenio(fechaVencimiento, codEmpresaConvenio, tipo);
        ...
        <div id="documento">
            <div id="contenido">
                ...
                <table style="width: 700px;font-size: 14px;">
                    <thead>
                        <tr class="bottom2">
                            <th colspan="3"><label>DEUDA PENDIENTE DE PAGO / <%=objEmpresaConvenio.getNombre()%> / <%=objcDatosCliente.tipoCliente(tipo)%> (Nombres) - V. <%=objcUtilitarios.fechaDateToString(fechaVencimiento)%></label></th>
                        </tr>
                        <tr class="bottom1">
