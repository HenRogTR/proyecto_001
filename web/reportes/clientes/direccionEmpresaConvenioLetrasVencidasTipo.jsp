<%-- 
    Document   : direccionEmpresaConvenioLetrasVencidasTipo
...
<%
    ...
    try {
        ...
        lLetrasVencidas = objcVentaCreditoLetra.letrasVencidas_codEmpresaConvenio_tipo_orderByDireccion(fechaVencimiento, codEmpresaConvenio, tipo);
        ...
        <div id="documento">
            <div id="contenido">
                ...
                <table style="width: 100%;font-size: 11px;">
                    <thead>
                        <tr class="bottom2">
                            <th colspan="8" style="font-size: 14px;"><label>LETRAS X COBRAR : <%=objEmpresaConvenio.getNombre()%> / <%=objcDatosCliente.tipoCliente(tipo)%></label></th>
                        </tr>
