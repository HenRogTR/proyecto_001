<%-- 
    Document   : nombresCEmpresaConvenioLetrasVencidasTipo
...
<%
    ...
    try {
        ...
        lLetrasVencidas = objcVentaCreditoLetra.letrasVencidas_codEmpresaConvenio_tipo_orderByNombresC(fechaVencimiento, codEmpresaConvenio, tipo);
