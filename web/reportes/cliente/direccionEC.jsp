<%-- 
    ...
    Created on : 22/02/2014, 10:35:27 AM
    Author     : Henrri
--%>
...
<%
    ...
    try {
        ...
        clienteList = new cDatosCliente().leer_empresaConvenio_ordenDireccion(codEC);
    } catch (Exception e) {
...
<html>
    <head>
        ...
        <title>Cartera clientes( dirección) <%=objEC.getNombre()%> <%=objcManejoFechas.fechaHoraActualNumerosLineal()%></title>
