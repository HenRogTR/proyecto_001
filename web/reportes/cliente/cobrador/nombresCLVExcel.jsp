...
<%
    ...
    try {
        ...
        LVList = new cVentaCreditoLetraReporte().letrasVencidas_codCobrador_total_ordenNombresC(new cManejoFechas().StringADate(fecha), objCobrador.getCodPersona());
        if (LVList == null) {
    ...
    response.setHeader("Content-Disposition", "attachment;filename=\"LETRAS VENCIDAS (APE/NOM) C:: " + objCobrador.getNombres() + " " + fecha + " " + objcManejoFechas.fechaHoraActualNumerosLineal() + ".xls\"");
%>
...
<html>
    <head>
        ...
        <title> letras por cobrar (ape/nom):: c. <%=objCobrador.getNombres()%> <%=fecha%> <%=objcManejoFechas.fechaHoraActualNumerosLineal()%></title>
    </head>
    <body>
        <div id="documento">
            <div id="contenido">
