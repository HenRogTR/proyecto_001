...
<%
    ...
    try {
        ...
        clienteList = new cDatosCliente().leer_codCobrador_empresaConvenio_ordenNombresC(codEC, codCobrador);
    } catch (Exception e) {
...
<html>
    <head>
        ...
        <title>Cartera clientes( Ape-Nombre) <%=objEC.getNombre()%>/<%=objCobrador.getNombres() %> <%=objcManejoFechas.fechaHoraActualNumerosLineal()%></title>
