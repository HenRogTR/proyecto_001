<%-- 
    Document   : nombresCLV
    Created on : 20/02/2014, 10:43:36 AM
    Author     : Henrri
--%>
...
<%
    ...
    try {
        ...
        LVList = new cVentaCreditoLetraReporte().letrasVencidas_codCobrador_ordenNombresC(new cManejoFechas().StringADate(fecha), codCobrador);
        if (LVList == null) {
                    ...
                    <thead>
                        <tr class="bottom2">
                            <th colspan="8" style="font-size: 14px;">
                                <span>Letras X cobrar (ape/nom) F.V. <%=fecha%> :: C. <%=objCobrador.getNombres()%> - <%=objcManejoFechas.fechaHoraActual()%></span>
                            </th>
                        </tr>
