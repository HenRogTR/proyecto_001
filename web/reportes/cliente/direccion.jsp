...
<%
    ...
    List clienteList = new cDatosCliente().leer_ordenadoDireccion();
    if (clienteList == null) {
...
<html>
    <head>
        ...
        <title>Cartera clientes X Dirección <%=objcManejoFechas.fechaHoraActualNumerosLineal()%></title>
        ...
        <div id="documento" style="width: 1000px;">
            <div id="contenido">
                <table class="anchoTotal">
                    <thead>
                        <tr>
                            <th colspan="2">Cartera de clientes X Dirección</th>
