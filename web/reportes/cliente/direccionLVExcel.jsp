...
<%
    ...
    try {
        ...
        LVList = new cVentaCreditoLetraReporte().letrasVencidas_total_ordenDireccion(new cManejoFechas().StringADate(fecha));
        if (LVList == null) {
    ...
    response.setHeader("Content-Disposition", "attachment;filename=\"LETRAS VENCIDAS (DIRECCION) " + fecha + " " + objcManejoFechas.fechaHoraActualNumerosLineal() + ".xls\"");
%>
...
<html>
    <head>
        ...
        <title> letras por cobrar (direccion) <%=fecha%> <%=objcManejoFechas.fechaHoraActualNumerosLineal()%></title>
    </head>
    <body>
        <div id="documento">
            <div id="contenido">
