...
//    variables
    ...
    try {
        ...
        lCobranza = objcCobranza.leer_anulados_fechaInicio_fechaFin_codCobrador(fechaInicio, fechaFin, codCobrador);
        if (lCobranza == null) {
        ...
        <div id="documento">
            <div id="contenido">
                <table style="font-size: 11px; width: 800px;">
                    <tr class="bottom2">
                        <th style="text-align: left;" colspan="3">REPORTE DE COBRANZA - <%=objcUtilitarios.fechaDateToString(fechaInicio)%> a <%=objcUtilitarios.fechaDateToString(fechaFin)%> - ANULADOS (C. <%=objCobrador.getNombres() %>)</th>                
