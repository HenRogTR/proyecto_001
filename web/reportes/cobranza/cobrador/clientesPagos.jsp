...
<%
    ...
    try {
        ...
        lCobranza = objcCobranza.leer_codCobrador_cobranzaGeneral(fechaInicio, fechaFin, codCobrador);
        if (lCobranza == null) {
        ...
        <div id="documento">
            <div id="contenido">
                <table style="font-size: 11px; width: 800px;">
                    <thead>
                        <tr class="bottom2">
                            <th style="text-align: left;" colspan="3">REPORTE DE COBRANZA - <%=objcUtilitarios.fechaDateToString(fechaInicio)%> a <%=objcUtilitarios.fechaDateToString(fechaFin)%> (C. <%=objCobrador.getNombres()%>)</th>                
