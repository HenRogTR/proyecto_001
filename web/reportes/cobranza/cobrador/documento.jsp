<%-- 
    Document   : documento
    Created on : 07/06/2013, 10:10:48 PM
    Author     : Henrri
--%>
...
//    String tipo = "";
    ...
    try {
        documento = request.getParameter("documento").toUpperCase();
        ...
        lCobranza = objcCobranza.leer_serie_fechaInicio_fechaFin_codCobrador(fechaInicio, fechaFin, documento, codCobrador);
        if (lCobranza == null) {
        ...
        <div id="documento">
            <div id="contenido">
                <table style="font-size: 11px; width: 800px;">
                    <tr class="bottom2">
                        <th style="text-align: left;" colspan="3">REPORTE DE COBRANZA - <%=objcUtilitarios.fechaDateToString(fechaInicio)%> a <%=objcUtilitarios.fechaDateToString(fechaFin)%> - SERIE: <%=documento.toUpperCase()%> (C. <%=objCobrador.getNombres()%>)</th>                
