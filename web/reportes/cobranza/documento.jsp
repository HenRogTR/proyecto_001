...
//    String tipo = "";
    ...
    try {
        ...
        lCobranza = objcCobranza.leer_serie_fechaInicio_fechaFin(fechaInicio, fechaFin, documento);
        if (lCobranza == null) {
        ...
        <div id="documento">
            <div id="contenido">
                <table style="font-size: 11px; width: 800px;">
                    <tr class="bottom2">
                        <th style="text-align: left;" colspan="3">REPORTE DE COBRANZA - <%=objcUtilitarios.fechaDateToString(fechaInicio)%> a <%=objcUtilitarios.fechaDateToString(fechaFin)%> - SERIE: <%=documento.toUpperCase()%></th>                
