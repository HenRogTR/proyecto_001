...
<%
    int codPersona = 0;
    try {
        codPersona = Integer.parseInt(request.getParameter("codPesona"));
    } catch (Exception e) {
        out.print("Error en parámteros");
        return;
    }
    cUtilitarios objcUtilitarios = new cUtilitarios();
    Persona objPersona = new cPersona().leer_cod(codPersona);
            ...
            <div id="contenido">
                ...
                <table class="tabla-imprimir" style="width: 650px;">
                    <thead>
                        ...
                        <tr class="bottom2">
                            <th style="width: 120px;">MES/AÑO</th>
                            <th style="width: 120px;">TOTAL MES</th>
                            <th style="">TOTAL INTERES</th>
                            <th style="width: 120px;">TOTAL PAGOS</th>
                            <th style="width: 120px;">TOTAL SALDO</th>
                        </tr>
                    </thead>
                    <tbody>
                        <%
                            List lVentaCreditoLetraRP = new cVentaCreditoLetra().leer_resumenPagos(codPersona);
