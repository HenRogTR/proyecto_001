...
<%
    ...
    try {
        ...
        objZona = new cZona().leer_cod(codZona);
        if (objZona == null) {
...
<html>
    <head>
        ...
        <script type="text/javascript" src="../librerias/persona/zona/zonaEditar.js"></script>
    </head>
    <body>
        ...
        <div id="wrap">
            ...
            <div id="right">
                <div id="rightSub1" class="ocultar">
                    <h3 class="titulo">EDITAR ZONA</h3>
                    <form id="formZonaEditar" action="../sZona">
                        <input type="hidden" name="accionZona" value="editar" />
                        <input type="hidden" name="codZona" id="codZona" value="<%=objZona.getCodZona()%>" />
                        <table class="reporte-tabla-1">                            
                            <tbody>
                                <tr>
                                    <th style="width: 120px;">COD. ZONA</th>
                                    <td id="lCodZona" class="vaciar" style="width: 320px;"><%=objcOtros.agregarCeros_int(objZona.getCodZona(), 8)%></td>
                                </tr>
                                <tr>
                                    <th>ZONA</th>
                                    <td id="lZona" class="vaciar contenedorEntrada"><input type="text" name="zona" id="zona" value="<%=objZona.getZona()%>" class="limpiar anchoTotal mayuscula"></td>
                                </tr>
                                <tr>
                                    <th>OBSERVACIÓN</th>
                                    <td id="lDescripcion" class="vaciar contenedorEntrada" style="height: 100px;"><textarea name="descripcion" id="descripcion" class="anchoTotal altoTotal mayuscula"><%=objZona.getDescripcion()%></textarea></td>
                                </tr>
                                <tr>
                                    <th colspan="2" class="centrado">
                                        ...
                                        <button type="submit" class="sexybutton"><span><span><span class="save">Editar</span></span></span></button>
                                    </th>
                                </tr>
                            </tbody>
                        </table>
