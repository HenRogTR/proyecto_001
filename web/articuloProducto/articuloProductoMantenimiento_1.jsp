        ...
        <div id="wrap">
            ...
            <div id="right">
                <div id="rightSub1" class="ocultar">                    
                    <h3 class="titulo">
                        <a id="bAPBuscar" class="boton iconoSoloNormal search">&nbsp;</a><br><br>
                    ...
                    <div id="dAPAccordion">
                        ...
                        <div>
                            <table class="reporte-tabla-1">
                                <thead>
                                    <tr>
                                        <th colspan="3" class="centrado medio alto24px">
                                            <span id="bPrimero" class="boton botonNormal first">Primero</span>
                                            <span id="bAnterior" class="boton botonNormal prev">Anterior</span>
                                            <span id="bSiguiente" class="boton botonNormal next">Siguiente</span>
                                            <span id="bUltimo" class="boton botonNormal last">Último</span>
                                        </th>
                                        <th class="centrado medio">
                                            <a id="bNuevo" class="boton iconoSoloNormal add">&nbsp;</a>
                                            <span id="bEditar" class="boton iconoSoloNormal edit">&nbsp;</span>
                                            <span id="bAnular" class="boton iconoSoloNormal delete">&nbsp;</span>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        <th class="medio">
                                            STOCK <button id="bStock" class="boton iconoSoloNormal info disabled" disabled="">&nbsp;</button>
                                        </th>
                                        <td id="lStock" class="vaciar"></td>
                                        <th class="medio">
                                            PRECIO VENTA <button id="bPrecioVentaModificar" class="boton iconoSoloNormal edit" disabled="">&nbsp;</button>
                                        </th>
                                        <td id="lPrecioVenta" class="vaciar medio"></td>
                                    </tr>
                                    <tr>
                                        <th>HABILITAR S/N</th>
