<%-- 
    Document   : familiaEditar
    Created on : 14/10/2013, 09:53:47 AM
    Author     : Henrri
--%>
...
<%
    ...
    try {
        ...
        objFamilia = new cFamilia().leer_cod(codFamilia);
        if (objFamilia == null) {
            response.sendRedirect("familiaMantenimiento.jsp");
            return;
        }
    } catch (Exception e) {
        response.sendRedirect("familiaMantenimiento.jsp");
...
<html>
    <head>
        ...
        <script type="text/javascript" src="../librerias/familia/familiaEditar.js"></script>
    </head>
    <body>
        ...
        <div id="wrap">
            ...
            <div id="right">
                <div id="rightSub1" class="ocultar">
                    <h3 class="titulo">EDITAR FAMILIA</h3>
                    <form action="../sFamilia" id="formFamiliaEditar">
                        <input type="hidden" name="accion" value="editar" />
                        <input type="hidden" name="codFamilia" value="<%=objFamilia.getCodFamilia() %>" />
                        <table class="reporte-tabla-1">
                            <tr>
                                <th class="ancho160px"><label for="codFamilia">COD. FAMILIA</label></th>
                                <td class="ancho360px"><%=objcOtros.agregarCeros_int(objFamilia.getCodFamilia(), 8)%></td>
                            </tr><tr>
                                <th>NOMBRE</th>
                                <td class="contenedorEntrada"><input type="text" name="familia" id="familia" value="<%=objFamilia.getFamilia()%>" class="limpiar anchoTotal mayuscula"/></td>
                            </tr>
                            <tr>
                                <th class="alto80px">OBSERVACIÓN</th>
                                <td class="contenedorEntrada"><textarea name="observacion" id="observacion" class="anchoTotal altoTotal limpiar mayuscula"><%=objFamilia.getObservacion()%></textarea></td>
                            </tr>
                            <tr id="trBoton">
                                <th colspan="2" class="centrado">
                                    ...
                                    <button class="sexybutton" type="submit"><span><span><span class="edit">Editar</span></span></span></button>
                                </th>
                            </tr>
                        </table>
                    </form>
