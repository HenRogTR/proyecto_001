...
public class cNumeroLetra {
    ...
    /**
     * Retorna un numero a letras el numero no debe tener mas de 2 decimales,
     * caso contrario este retornara <b>null</b>
     *
     * @param numero [0 ; 999999999.99]
     * @param mayusculas Indicar si se requiere el resultado en mayúscula.
     * @return
     */
    // </editor-fold>
    public String importeNumeroALetra(String numero, boolean mayusculas) {
        String literal = "";
    ...
    public String importeNumeroALetra(String numero, boolean mayusculas, String moneda) {
        String literal = "";
        String parte_decimal;
        //si el numero utiliza (.) en lugar de (,) -> se reemplaza
        numero = numero.replace(".", ",");
        ...
        if (Pattern.matches("\\d{1,9},\\d{1,2}", numero)) {
            ...
            String Num[] = numero.split(",");
            //de da formato al numero decimal
            parte_decimal = "con " + (Num[1].length() <= 1 ? Num[1] + "0" : Num[1]) + "/100 " + moneda;
            //se convierte el numero a literal
            if (Integer.parseInt(Num[0]) == 0) {//si el valor es cero
                literal = "cero ";
            } else if (Integer.parseInt(Num[0]) > 999999) {//si es millon
    ...
    // <editor-fold defaultstate="collapsed" desc="Haga clic en el signo + para mostrar descripción">
    /**
     * Retorna un numero a letras. caso contrario este retornara <b>null</b>
     *
     * @param numero [0 ; 999999999]
     * @param mayusculas Indicar si se requiere el resultado en mayúscula.
     * @return
     */
    // </editor-fold>
