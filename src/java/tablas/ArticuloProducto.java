...
public class ArticuloProducto  implements java.io.Serializable {
    ...
    public ArticuloProducto(Familia familia, Marca marca, String codReferencia, String descripcion, double precioVenta, int precioVentaRango, Double precioCash, String unidadMedida, Boolean usarSerieNumero, Boolean reintegroTributario, String observaciones, String foto, String registro, Set<CompraDetalle> compraDetalles, Set<PrecioVenta> precioVentas, Set<KardexArticuloProducto> kardexArticuloProductos, Set<VentasDetalle> ventasDetalles) {
       this.familia = familia;
       this.marca = marca;
